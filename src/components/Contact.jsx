...
const Contact = () => {
  ...
  return (
    <VStack padding={'2em'} id="contact" >
    <Heading fontSize={'3.5rem'} margin={'1rem auto'} borderBottom={'2px solid white'} width={'min-content'}>Contact!</Heading>
    <button  className="lightHover">
  <div className="button__int">
   <FormControl gap={'1em'}  display={'flex'} flexDir={'column'} borderRadius={'1em'} padding={'2em'} width={'70vw'} margin={'auto'} bg={'#8C1BAB'} color={'white'}>
    <FormLabel fontSize={'1.8em'}>Name:</FormLabel> <Input placeholder="Enter your name..."/>
    <FormLabel fontSize={'1.8em'}>Mail:</FormLabel> <Input placeholder="Enter your email..."/>
    <FormLabel fontSize={'1.8em'}>Message:</FormLabel> <Textarea placeholder="Enter your message..."/>
    <div style={{alignSelf:"flex-end"}} className="voltage-button">
